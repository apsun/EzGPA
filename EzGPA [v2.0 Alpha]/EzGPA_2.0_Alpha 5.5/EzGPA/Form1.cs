...
namespace EzGPA
{
    public partial class Form1 : Form
    {
        ...
        private void SaveRegistrySettings(RegistryKey regKey, string value, object data)
        {
            ...
            {
                //User probably modified registry permissions while the app was running >_>
        ...
        private double CalcFinalGPA()
        {
            ...
            if (tabControl1.SelectedIndex == 0)
            {
                ...
                //The native/non-native checking has been removed because
                //not doing so would cause the GPA to be inaccurate when
                //hovering over the native/non-native options.
