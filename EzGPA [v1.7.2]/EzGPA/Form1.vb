Public Class Form1
    ...
    Dim VersionNumber As String = "1.7.3"
    Dim MajorEdit As String = "a"
    Dim ChangeLogEN As String = "Made minor changes to the UI and tooltips."
    Dim FutureChangesEN As String = "Screw this thing up and go play WoW 24/7. :p"
    Dim ChangeLogCN As String = "O2"
    Dim FutureChangesCN As String = "O2"
    ...
    Private Sub ReadWriteRegistryValues(Optional Action As String = Nothing)
        ...
        ElseIf My.Computer.Registry.GetValue("HKEY_CURRENT_USER\Software\EzGPA", "MajorEdit", Nothing) <> MajorEdit Then
            MsgBox("An older (or possibly newer) version of EzGPA has been detected which conflicts with the currently stored settings. As a result, all settings have been reset to their default values.", MsgBoxStyle.Information)
            Dim TempRegKey = Registry.CurrentUser.OpenSubKey("Software", True)
    ...
    Private Sub CalculateSubjectGPA(Score As Integer)
        If Score >= 93 Then
            SubjectGPA = 4
    ...
    Private Sub About_Click(sender As System.Object, e As System.EventArgs) Handles About.Click
        If ApplicationLanguage = "English" Then
            MsgBox("EzGPA v" & VersionNumber & Environment.NewLine & "Copyright © 2011-2012 Andrew Sun <crossbowffs@live.com>" & Environment.NewLine & "Built on: " & RetrieveLinkerTimestamp() & Environment.NewLine & Environment.NewLine & "v" & VersionNumber & " changelog: " & ChangeLogEN & Environment.NewLine & Environment.NewLine & "Future changes: " & FutureChangesEN, MsgBoxStyle.Information)
        ElseIf ApplicationLanguage = "Chinese" Then
            MsgBox("EzGPA v" & VersionNumber & Environment.NewLine & "版权所有 © 2011-2012 Andrew Sun <crossbowffs@live.com>" & Environment.NewLine & "编译日期: " & RetrieveLinkerTimestamp() & Environment.NewLine & Environment.NewLine & "v" & VersionNumber & " 更改日志: " & ChangeLogCN & Environment.NewLine & Environment.NewLine & "未来改进: " & FutureChangesCN, MsgBoxStyle.Information)
        End If
    End Sub

    Function RetrieveLinkerTimestamp() As DateTime 'http://www.codinghorror.com/blog/2005/04/determining-build-date-the-hard-way.html
