Public Class Form1
    ...
    Dim ChangeLogEN As String = "Fixed the infinite loop when selecting 'no' when asked to reset user settings. Also made some minor UI/text modifications."
    Dim FutureChangesEN As String = "Absolutely nothing."
